...
int main(int argc, char *argv[])
{
  ...
  unsigned char Image1[SizeX][SizeY][BytesPerPixel];
	...
	unsigned char ImageOut1[SizeX][SizeY][BytesPerPixel];


	vector<vector<unsigned char>> I1(SizeX,vector<unsigned char>(SizeY, 0));

	vector<vector<unsigned char>> I1O(SizeX,vector<unsigned char>(SizeY, 0));
	...
	fwrite(ImageOut1, sizeof(unsigned char), SizeX*SizeY*BytesPerPixel, file);
	fclose(file);
