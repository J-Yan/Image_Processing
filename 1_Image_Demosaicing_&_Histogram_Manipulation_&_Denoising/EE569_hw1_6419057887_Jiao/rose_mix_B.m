...
title('histogram of rose\_mix.raw');
...
title('cumulative histogram of rose\_mix.raw');
xlabel('Pixel Intensity');
...
title('rose\_mix.raw Method B enhanced');
...
title('histogram of rose\_mix.raw enhanced Method B');
xlabel('Pixel Intensity');
ylabel('Pixel Frequency');
...
title('cumulative histogram of rose\_mix.raw method B enhanced');
xlabel('Pixel Intensity');
ylabel('cumulative Pixel Frequency');