...
title('cumulative histogram of rose\_dark.raw');
xlabel('Pixel Intensity');
...
title('rose\_dark.raw Method B enhanced');
...
title('histogram of rose\_dark.raw enhanced Method B');
xlabel('Pixel Intensity');
ylabel('Pixel Frequency');
...
title('cumulative histogram of rose\_dark.raw method B enhanced');
xlabel('Pixel Intensity');
ylabel('cumulative Pixel Frequency');