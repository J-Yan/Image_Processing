...
% subplot(1,2,1),bar(histArray);
figure,bar(histArray);
title('histogram of rose\_bright.raw');
xlabel('Pixel Intensity');
ylabel('Pixel Frequency');
%subplot(1,2,2),bar(histArray/len);
% title('histogram of rose_ori.raw');
% xlabel('Pixel Intensity');
...
title('cdf of rose\_bright.raw enhanced');
xlabel('Pixel Intensity');
ylabel('cdf');
...
title('rose\_bright.raw enhanced');
...
title('histogram of rose\_bright.raw enhanced');
xlabel('Pixel Intensity');
ylabel('Pixel Frequency');